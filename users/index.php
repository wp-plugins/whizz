...
function whizz_enqueue_and_register_my_scripts_users()
{
	...
	wp_register_script( 'reg_custom_users_js_h', plugin_dir_url(__FILE__).'js/custom-js-user-view.js',array('jquery','jquery-ui-core','jquery-ui-draggable','jquery-ui-droppable','jquery-ui-sortable') , false, false );
