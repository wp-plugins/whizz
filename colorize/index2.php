...
function whizz_enqueue_and_register_my_scripts_color()
{
	...
	wp_register_script( 'reg_custom_colorize_js_h', plugin_dir_url(__FILE__).'js/custom-js-colorize.js',array('jquery','jquery-ui-core','jquery-ui-draggable','jquery-ui-droppable','jquery-ui-sortable','wp-color-picker') , false, false );
