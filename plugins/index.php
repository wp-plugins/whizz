...
function whizz_enqueue_and_register_my_scripts_plugin()
{
	...
	wp_register_script( 'reg_custom_plugin_js_h', plugin_dir_url(__FILE__).'js/custom-js-plugin-view.js',array('jquery','jquery-ui-core','jquery-ui-draggable','jquery-ui-droppable','jquery-ui-sortable') , false, false );	
